...
/**
 * Represents a CuddleCoin Transaction
 */
class Transaction {
    constructor() {
        this.version = 1;
    ...
    hash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(this.m_cached.blob);
            if (this.version >= 2) {
                const hash2 = yield Types_1.CuddleCoinCrypto.cn_fast_hash(hash + TransactionVersion2Suffix);
    ...
    prefixHash() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(this.m_cached.prefix);
            if (this.version >= 2) {
                const hash2 = yield Types_1.CuddleCoinCrypto.cn_fast_hash(hash + TransactionVersion2Suffix);
    ...
    parseExtra(extra) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.publicKey && (yield Types_1.CuddleCoinCrypto.checkKey(this.publicKey))) {
