...
class LedgerNote extends events_1.EventEmitter {
    ...
    generateKeyDerivation(transactionPublicKey, privateViewKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, this.address.view.privateKey);
        });
    }
    /**
    ...
    generateKeyImage(transactionPublicKey, privateViewKey, publicSpendKey, privateSpendKey, outputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const derivation = yield Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, this.address.view.privateKey);
    ...
    generateKeyImagePrimitive(publicSpendKey, privateSpendKey, outputIndex, derivation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            UNUSED(publicSpendKey);
            UNUSED(privateSpendKey);
            const publicEphemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(derivation, outputIndex, this.address.spend.publicKey);
    ...
    isOurTransactionOutput(transactionPublicKey, output, privateViewKey, publicSpendKey, privateSpendKey, generatePartial = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            UNUSED(publicSpendKey);
            UNUSED(privateSpendKey);
            const derivedKey = yield Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, this.address.view.privateKey);
            const publicEphemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(derivedKey, output.index, this.address.spend.publicKey);
    ...
    completeTransaction(preparedTransaction, privateSpendKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const meta of preparedTransaction.signatureMeta) {
                ...
                const public_ephemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(meta.input.derivation, meta.input.outputIndex, this.m_address.spend.publicKey);
