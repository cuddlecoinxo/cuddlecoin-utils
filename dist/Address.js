...
/**
 * Represents a CuddleCoin address
 */
class Address {
    constructor() {
    ...
    static fromAddress(address, prefix) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const checksum = (new bytestream_1.Reader(yield Types_1.CuddleCoinCrypto.cn_fast_hash(decodedPrefix + paymentId + publicSpend + publicView))).bytes(SIZES.CHECKSUM).toString('hex');
    ...
    static fromSeed(seed, language, prefix) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Common_1.Common.isHex64(seed)) {
                seed = yield Types_1.CuddleCoinCrypto.cn_fast_hash(seed);
            }
            const address = new Address();
            address.m_seed = seed;
    ...
    static generateSubwallet(privateSpendKey, subwalletIndex, language, prefix) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield Types_1.CuddleCoinCrypto.checkScalar(privateSpendKey))) {
            ...
            const spend = yield Types_1.CuddleCoinCrypto.generateDeterministicSubwalletKeys(privateSpendKey, subwalletIndex);
    ...
    toString() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const checksum = (yield Types_1.CuddleCoinCrypto.cn_fast_hash(writer.blob))
                .slice(0, 8);
