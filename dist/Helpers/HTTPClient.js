...
/** @ignore */
class HTTPClient {
    constructor(host = '127.0.0.1', port = 12898, timeout = 30000, ssl = false, userAgent = util_1.format('%s/%s', packageInfo.name, packageInfo.version), keepAlive = true, apiKey, errorHandler) {
        this.m_host = host;
        this.m_port = port;
