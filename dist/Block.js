...
class Block {
    ...
    baseTransactionBranch() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Types_1.CuddleCoinCrypto.tree_branch(transactions);
        });
    }
    /**
    ...
    transactionTreeHash() {
        return __awaiter(this, void 0, void 0, function* () {
            const transactions = [yield this.m_minerTransaction.hash()].concat(this.transactions);
            const treeHash = yield Types_1.CuddleCoinCrypto.tree_hash(transactions);
    ...
    static from(data, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (block.m_majorVersion >= block.m_config.activateParentBlockVersion) {
                ...
                const baseTransactionBranchDepth = yield Types_1.CuddleCoinCrypto.tree_depth(block.m_parentBlock.transactionCount);
    ...
    toHashingBuffer(headerOnly = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.m_majorVersion >= this.m_config.activateParentBlockVersion) {
                ...
                writer.hash(this.m_parentBlock.previousBlockHash);
                writer.uint32_t(this.m_nonce, true);
                const treeHash = yield Types_1.CuddleCoinCrypto.tree_hash_from_branch(this.m_parentBlock.baseTransactionBranch, yield this.m_parentBlock.minerTransaction.hash(), 0);
...
function getBlockHash(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        writer.write(data);
        return Types_1.CuddleCoinCrypto.cn_fast_hash(writer.blob);
    });
}
/** @ignore */
function getBlockPoWHash(data, majorVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (majorVersion) {
            ...
            case 2:
            case 3:
                return Types_1.CuddleCoinCrypto.cn_slow_hash_v0(blob);
            case 4:
                return Types_1.CuddleCoinCrypto.cn_lite_slow_hash_v1(blob);
            case 5:
                return Types_1.CuddleCoinCrypto.cn_turtle_lite_slow_hash_v2(blob);
            case 6:
                return Types_1.CuddleCoinCrypto.chukwa_slow_hash_v1(blob);
            case 7:
                return Types_1.CuddleCoinCrypto.chukwa_slow_hash_v2(blob);
            default:
