"use strict";
// Copyright (c) 2020, The CuddleCoin Developers
//
...
class Multisig {
    ...
    view() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Types_1.CuddleCoinCrypto.calculateSharedPrivateKey(this.m_view_keys);
        });
    }
    /**
    ...
    spend() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Types_1.CuddleCoinCrypto.calculateSharedPublicKey(keys);
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.m_threshold !== this.m_participants) {
                ...
                for (const multisig_key of this.m_wallet_multisig_keys) {
                    const keys = yield Types_1.CuddleCoinCrypto.calculateMultisigPrivateKeys(multisig_key.privateKey, this.m_participant_keys);
                    for (const key of keys) {
    ...
    static fromMultisigKeys(multisig_private_keys, sharedPrivateViewKey, threshold, participants) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const key of multisig_private_keys) {
                if (!(yield Types_1.CuddleCoinCrypto.checkScalar(key))) {
            ...
            if (!(yield Types_1.CuddleCoinCrypto.checkScalar(sharedPrivateViewKey))) {
    ...
    static restoreKeyImage(publicEphemeral, derivation, outputIndex, partialKeyImages) {
        return __awaiter(this, void 0, void 0, function* () {
            return Types_1.CuddleCoinCrypto.restoreKeyImage(publicEphemeral, derivation, outputIndex, partialKeyImages);
        });
    }
    /**
    ...
    addParticipant(publicSpendKeys, privateViewKey) {
        return __awaiter(this, void 0, void 0, function* () {
            if (privateViewKey && !(yield Types_1.CuddleCoinCrypto.checkScalar(privateViewKey))) {
                throw new Error('Private view key is not a valid private key');
            }
            ...
            for (const key of publicSpendKeys) {
                if (!(yield Types_1.CuddleCoinCrypto.checkKey(key))) {
    ...
    generatePartialKeyImages(transactionHash, publicEphemeral, outputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const multisigKey of this.m_multisig_keys) {
                promises.push(Types_1.CuddleCoinCrypto.generateKeyImage(publicEphemeral, multisigKey.privateKey));
            }
...
function generatePartialSigningKey(preparedSignature, index, privateSpendKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const key = yield Types_1.CuddleCoinCrypto.generatePartialSigningKey(preparedSignature, privateSpendKey);
        return {
            key,
            index
        };
...
function restoreRingSignatures(derivation, outputIndex, partialSigningKeys, realOutputIndex, key, signatures, index) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const sigs = yield Types_1.CuddleCoinCrypto.restoreRingSignatures(derivation, outputIndex, keys, realOutputIndex, key, signatures);
        return {
            sigs,
            index
        };
