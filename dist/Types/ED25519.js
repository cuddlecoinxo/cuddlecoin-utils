    ...
    class KeyPair {
        ...
        static from(publicKey, privateKey, entropy, iterations, createEmpty = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (publicKey && (yield Types_1.CuddleCoinCrypto.checkKey(publicKey))) {
                    pair.m_publicKey = publicKey;
                }
                if (privateKey && (yield Types_1.CuddleCoinCrypto.checkScalar(privateKey))) {
                ...
                if (pair.m_privateKey && !pair.m_publicKey) {
                    ...
                    if (iterations && iterations === 1) {
                        const temp = yield Types_1.CuddleCoinCrypto.cn_fast_hash(pair.m_privateKey);
                        yield pair.setPrivateKey(temp);
                    }
                    pair.m_publicKey = yield Types_1.CuddleCoinCrypto.secretKeyToPublicKey(pair.m_privateKey);
                }
                return pair;
            });
        }
        ...
        setPrivateKey(key) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    this.m_privateKey = (yield Types_1.CuddleCoinCrypto.checkScalar(key))
                        ? key
                        : yield Types_1.CuddleCoinCrypto.scReduce32(key);
                }
                catch (e) {
        ...
        setPublicKey(key) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    isPubKey = yield Types_1.CuddleCoinCrypto.checkKey(key);
                }
                catch (e) {
        ...
        isPaired() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return ((yield Types_1.CuddleCoinCrypto.secretKeyToPublicKey(this.privateKey)) === this.publicKey);
            });
        }
    }
    ED25519.KeyPair = KeyPair;
    /**
     * Represents a set of ED25519 key pairs (view and spend) used by CuddleCoin wallets
     */
    class Keys {
        constructor() {
...
function simpleKdf(value, iterations) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < iterations; i++) {
            hex = yield Types_1.CuddleCoinCrypto.cn_fast_hash(hex);
        }
        return hex;
    });
}
