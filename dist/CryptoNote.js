...
class CryptoNote extends events_1.EventEmitter {
    ...
    constructor(config, cryptoConfig) {
        ...
        if (cryptoConfig) {
            Types_1.CuddleCoinCrypto.userCryptoFunctions = cryptoConfig;
        }
    }
    /** @ignore */
    on(event, listener) {
     ...
     */
    get cryptoConfig() {
        return Types_1.CuddleCoinCrypto.userCryptoFunctions;
    }
    set cryptoConfig(config) {
        Types_1.CuddleCoinCrypto.userCryptoFunctions = config;
    }
    /**
    ...
    generateKeyDerivation(transactionPublicKey, privateViewKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
        });
    }
    /**
    ...
    generateKeyImage(transactionPublicKey, privateViewKey, publicSpendKey, privateSpendKey, outputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            const derivation = yield Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
    ...
    generateKeyImagePrimitive(publicSpendKey, privateSpendKey, outputIndex, derivation) {
        return __awaiter(this, void 0, void 0, function* () {
            const publicEphemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(derivation, outputIndex, publicSpendKey);
            const privateEphemeral = yield Types_1.CuddleCoinCrypto.deriveSecretKey(derivation, outputIndex, privateSpendKey);
            const keyImage = yield Types_1.CuddleCoinCrypto.generateKeyImage(publicEphemeral, privateEphemeral);
            return {
    ...
    privateKeyToPublicKey(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return Types_1.CuddleCoinCrypto.secretKeyToPublicKey(privateKey);
        });
    }
    /**
    ...
    isOurTransactionOutput(transactionPublicKey, output, privateViewKey, publicSpendKey, privateSpendKey, generatePartial) {
        return __awaiter(this, void 0, void 0, function* () {
            const derivedKey = yield Types_1.CuddleCoinCrypto.generateKeyDerivation(transactionPublicKey, privateViewKey);
            const publicEphemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(derivedKey, output.index, publicSpendKey);
            if (publicEphemeral === output.key) {
                ...
                if (privateSpendKey) {
                    ...
                    const privateEphemeral = (generatePartial)
                        ? privateSpendKey
                        : yield Types_1.CuddleCoinCrypto.deriveSecretKey(derivedKey, output.index, privateSpendKey);
                    const derivedPublicEphemeral = yield Types_1.CuddleCoinCrypto.secretKeyToPublicKey(privateEphemeral);
    ...
    signMessage(message, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const publicKey = yield Types_1.CuddleCoinCrypto.secretKeyToPublicKey(privateKey);
            const hex = Buffer.from(message);
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(hex.toString('hex'));
            return Types_1.CuddleCoinCrypto.generateSignature(hash, publicKey, privateKey);
        });
    }
    /**
    ...
    verifyMessageSignature(message, publicKey, signature) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hex = Buffer.from(message);
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(hex.toString('hex'));
            return Types_1.CuddleCoinCrypto.checkSignature(hash, publicKey, signature);
        });
    }
    /**
     * Constructs a new Transaction using the supplied values.
     * The resulting transaction can be broadcasted to the CuddleCoin network
     * @async
...
function checkRingSignatures(hash, keyImage, publicKeys, signatures) {
    return __awaiter(this, void 0, void 0, function* () {
        return Types_1.CuddleCoinCrypto.checkRingSignatures(hash, keyImage, publicKeys, signatures);
    });
}
/** @ignore */
function generateRingSignatures(hash, keyImage, publicKeys, privateKey, realOutputIndex, index) {
    return __awaiter(this, void 0, void 0, function* () {
        const signatures = yield Types_1.CuddleCoinCrypto.generateRingSignatures(hash, keyImage, publicKeys, privateKey, realOutputIndex);
...
function prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex, derivation, outputIndex, index, tx_public_key, randomKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const prepped = yield Types_1.CuddleCoinCrypto.prepareRingSignatures(hash, keyImage, publicKeys, realOutputIndex, randomKey);
        return {
            index: index,
...
function completeRingSignatures(privateSpendKey, derivation, outputIndex, realOutputIndex, key, sigs, index) {
    return __awaiter(this, void 0, void 0, function* () {
        const privateEphemeral = yield Types_1.CuddleCoinCrypto.deriveSecretKey(derivation, outputIndex, privateSpendKey);
        const signatures = yield Types_1.CuddleCoinCrypto.completeRingSignatures(privateEphemeral, realOutputIndex, key, sigs);
        return { signatures, index };
    });
}
/** @ignore */
...
function prepareTransactionOutputs(outputs) {
    return __awaiter(this, void 0, void 0, function* () {
        function prepareOutput(destination, amount, index, privateKey) {
            return __awaiter(this, void 0, void 0, function* () {
                const outDerivation = yield Types_1.CuddleCoinCrypto.generateKeyDerivation(destination.view.publicKey, privateKey);
                const outPublicEphemeral = yield Types_1.CuddleCoinCrypto.derivePublicKey(outDerivation, index, destination.spend.publicKey);
                return {
                    amount,
        ...
        const keys = yield Types_1.CuddleCoinCrypto.generateKeys();
