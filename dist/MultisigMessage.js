...
class MultisigMessage {
    ...
    static decode(destination, base58) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(rawData);
            ...
            if (!(yield Types_1.CuddleCoinCrypto.checkSignature(hash, source.spend.publicKey, signature))) {
    ...
    encode() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hash = yield Types_1.CuddleCoinCrypto.cn_fast_hash(writer.blob);
            const sig = yield Types_1.CuddleCoinCrypto.generateSignature(hash, this.source.spend.publicKey, this.source.spend.privateKey);
            writer.hex(sig);
...
function encrypt(source, destination, payload, nonce) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const aesKey = Buffer.from(yield Types_1.CuddleCoinCrypto.generateKeyDerivation(destination.spend.publicKey, source.spend.privateKey), 'hex');
...
function decrypt(destination, transfer, nonce) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const aesKey = Buffer.from(yield Types_1.CuddleCoinCrypto.generateKeyDerivation(sender.spend.publicKey, destination.spend.privateKey), 'hex');
        // eslint-disable-next-line new-cap
        const ctx = new aes_js_1.ModeOfOperation.ctr(aesKey, new aes_js_1.Counter(nonce));
...
function calculateSpendKeySignatures(spendKeys) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const keys of spendKeys) {
            ...
            const sig = yield Types_1.CuddleCoinCrypto.generateSignature(keys.publicKey, keys.publicKey, keys.privateKey);
...
function verifySpendKeySignatures(spendKeys) {
    return __awaiter(this, void 0, void 0, function* () {
        for (const spendKey of spendKeys) {
            if (!(yield Types_1.CuddleCoinCrypto.checkSignature(spendKey.key, spendKey.key, spendKey.signature))) {
